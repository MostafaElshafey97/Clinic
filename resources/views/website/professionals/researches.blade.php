                    ...
                    <div class="st-post-details st-style1">
                        ...
                        <div class="course_con">
                            ...
                            <div class="course_text">
                                ...
                                <a href="{{$researcher->link}}" target="_blank">Source </a>
                                <!-- <a href="{{secure_asset('assets/img/'.$researcher->source)}}" target="_blank">Source</a> -->
                                {{-- <img src="{{secure_asset('assets/img/'.$researcher->source)}}" style="width: 400px"  alt=""> --}}
